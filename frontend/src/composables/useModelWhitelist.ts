...
const openaiPresetMappings = [
  ...
  { label: 'Free GPT-5.5', from: 'gpt-5.5', to: 'gpt-5.5', color: 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300' },
  { label: 'Free 5.4 Mini', from: 'gpt-5.4-mini', to: 'gpt-5.4-mini', color: 'bg-sky-100 text-sky-700 hover:bg-sky-200 dark:bg-sky-900/30 dark:text-sky-400' },
